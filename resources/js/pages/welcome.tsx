    ...
    <div className="max-w-4xl mx-auto p-8 space-y-8">
      <form onSubmit={submit}>
        <div className="border-b pb-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground pb-8">Silakan isi data kehadiran anda dengan benar.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={(value) => setData("tanggal", value)}
                  />
                </PopoverContent>
              </Popover>
            ...
            {checked && (
              <>
                ...
                <div className="grid gap-2">
                  <Label htmlFor="biaya_parkir">Biaya Tol</Label>
                  <Input
                    id="biaya_parkir"
                    type="number"
